...
def _main():
    ...
    # 2P2F
    h1D_m4l_SR_2P2F = fileData.Get("h1D_m4l_SR_2P2F")
    h1D_m4l_SR_2P2F_4e = fileData.Get("h1D_m4l_SR_2P2F_4e")
    h1D_m4l_SR_2P2F_4mu = fileData.Get("h1D_m4l_SR_2P2F_4mu")
    h1D_m4l_SR_2P2F_2e2mu = fileData.Get("h1D_m4l_SR_2P2F_2e2mu")
    h1D_m4l_SR_2P2F_2mu2e = fileData.Get("h1D_m4l_SR_2P2F_2mu2e")
    # 3P1F
    h1D_m4l_SR_3P1F = fileData.Get("h1D_m4l_SR_3P1F")
    h1D_m4l_SR_3P1F_4e = fileData.Get("h1D_m4l_SR_3P1F_4e")
    h1D_m4l_SR_3P1F_4mu = fileData.Get("h1D_m4l_SR_3P1F_4mu")
    h1D_m4l_SR_3P1F_2e2mu = fileData.Get("h1D_m4l_SR_3P1F_2e2mu")
    h1D_m4l_SR_3P1F_2mu2e = fileData.Get("h1D_m4l_SR_3P1F_2mu2e")

    print("------------3P1F Data-----------------")
    print("m4l_SR_3P1F = " + str(h1D_m4l_SR_3P1F.Integral()))
    print("m4l_SR_3P1F_4e = " + str(h1D_m4l_SR_3P1F_4e.Integral()))
    print("m4l_SR_3P1F_4mu = " + str(h1D_m4l_SR_3P1F_4mu.Integral()))
    print("m4l_SR_3P1F_2e2mu = " + str(h1D_m4l_SR_3P1F_2e2mu.Integral()))
    print("m4l_SR_3P1F_2mu2e = " + str(h1D_m4l_SR_3P1F_2mu2e.Integral()))
    print("--------------------------------")
    ...
    fileZZ = ROOT.TFile (infile_ZZ, "READ")
    #--- Retrieve ZZ histograms.
    # 3P1F
    ZZ_4e = fileZZ.Get("h1D_m4l_SR_3P1F_4e")
    ZZ_4mu = fileZZ.Get("h1D_m4l_SR_3P1F_4mu")
    ZZ_2e2mu = fileZZ.Get("h1D_m4l_SR_3P1F_2e2mu")
    ZZ_2mu2e = fileZZ.Get("h1D_m4l_SR_3P1F_2mu2e")
    ZZ_tot = fileZZ.Get("h1D_m4l_SR_3P1F")
    ...
    print("...Removing ZZ contribution from 3P1F...")
